...
var Instructions;module.exports=Instructions=function(){function e(){this.dom=document.getElementById("instructions")}var t;return t=function(e){return"— "+e+" —"},e.prototype.start=function(e){return this.setMessage(this.startMessage(e))},e.prototype.end=function(e){return this.setMessage(this.endMessage(e))},e.prototype.setMessage=function(e){if(null!=e)return this.dom.innerHTML=e},e.prototype.startMessage=function(e){switch(e){case 0:return null;case 1:return t("Versuch' dieses hier");case 2:return t("Sieht hübsch aus, oder? Klicke auf das Element in der Mitte unten, um zwei Ringe herzustellen");case 3:return t("Es kann mehrere Schleifen geben. So wie in diesem Beispiel");case 4:return"(Das Spiel heißt ADINFINITVM, alles klar?)";case 5:return t("Schau mal, wie weit du kommst");case 7:return"(Hinweis: Es gibt einen alternativen Modus. Klicke dafür auf das ♦ rechts unten)";default:return"&nbsp;"}},e.prototype.endMessage=function(e){switch(e){case 0:return t("Nun klicke irgendwo, um zum nächsten Level zu gelangen");case 10:return t("#10 schon. Das machst du gut!");case 50:return t("Toll! #50");case 1337:return t("#1337 — 11100010 10011101 10100100");default:return t("#"+e)}},e.prototype.tweetMessage=function(e){var n,s;return s="I've just completed level "+e+" in @amoebe's #adinfinitvm game! https://bxt.github.io/adinfinitvm/",n="http://twitter.com/home?status="+encodeURIComponent(s),t("congratulations! you have completed #"+e+'.\n<a class="button" href="'+n+'" target="_blank">tweet</a>')},e}();
